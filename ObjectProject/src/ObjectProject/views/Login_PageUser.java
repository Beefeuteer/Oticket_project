...
public class Login_PageUser extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Login_PageUser window = new Login_PageUser();
	...
	private void initialize() {
		...
		frmLoginAdmin.setTitle("Login User");
		...
		JLabel lblAdminPage = new JLabel("User Login Page");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					String sql = "select * from loginuser where USERNAME='" + txtrId.getText() + "'and PASSWRD='" + passwordField.getText().toString() + "'";
